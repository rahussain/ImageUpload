    ...
    <main>
        <section id="main" runat="server">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" maxlength="301" id="txtTitle" class="form-controll" required="required" runat="server" />
            </div>
            <div class="form-group">
                <label for="title">Image Name</label>
                <input type="text" name="imageName" maxlength="301" id="txtImageName" class="form-controll" required="required" runat="server" />
            </div>
